...
class AudioDownloader:
    ...
    def download_audio(self, url: str, uploader: 'StorageUploader' = None) -> Optional[Dict[str, Any]]:
        """
        下载音频并返回音频信息
...
class StorageUploader:
    ...
    def upload_audio(self, file_path: str, filename: str) -> Optional[str]:
        """上传音频文件并返回访问URL"""
...
def create_uploader(storage_config) -> Optional[StorageUploader]:
    """根据配置创建上传器"""
