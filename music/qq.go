...
import (
	...
	"github.com/wdvxdr1123/alisten/music/kuwo"
)

var qqBaseUrl = "http://123.60.73.23:3300"
...
func QQPost(u string, k gin.H) gjson.Result {
	...
	dest := fmt.Sprintf("%s%s", qqBaseUrl, u)
	...
	/*
	   {
	        ...
	        "diss_status": 400,
	        "dissid": "3805603854",
	        "dissname": "周杰伦歌曲大全！一张歌单全听完",
	        "docid": 3805603854,
	        "imgurl": "http://p.qpic.cn/music_cover/gaSSCRswoq7NlpHA8vK1PlQBJ2PTPia46icDP0S5LXEvDwJF2lgPh6fQ/600",
	        "introduction": "“周杰伦”三个字是不变的信仰！&#10;歌单收集杰伦最全歌曲合集，所有关于杰伦的都值�.&#46;&#46;",
	        "listennum": 852284084,
	        "score": 0,
	        "song_count": 210
	      },
